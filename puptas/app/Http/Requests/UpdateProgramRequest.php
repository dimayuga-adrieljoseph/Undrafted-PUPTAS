...
/**
 * Form Request for updating an existing program
 * 
 * Validates program update data including strand associations.
 */
    ...
    public function rules(): array
    {
        ...
        return [
            'name' => [
                ...
                'string',
                'max:255',
                Rule::unique(Program::class, 'name')->ignore($programId),
            ],
            'code' => [
                'sometimes',
                'required',
                'string',
                'max:50',
                Rule::unique(Program::class, 'code')->ignore($programId),
            ],
