...
const showProgramAssignment = computed(() => {
    return ['3', '4'].includes(form.role_id.toString()); // Evaluator (3) and Interviewer (4)
});

const showApplicantProgram = computed(() => {
    return form.role_id.toString() === '1'; // Applicant
});
            ...
            <div class="header-section">
                <div class="header-content">
                    <div class="header-left">
                        ...
                        <p class="page-subtitle">Update user account details, roles, and permissions</p>
                    </div>
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card role-card" v-for="(count, roleId) in userCountsByRole" :key="roleId">
                        <div class="stat-icon">
                            <svg viewBox="0 0 24 24">
                                <!-- Applicant Icon -->
                                <path v-if="parseInt(roleId) === 1" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM7.07 18.28c.43-.9 3.05-1.78 4.93-1.78s4.51.88 4.93 1.78C15.57 19.36 13.86 20 12 20s-3.57-.64-4.93-1.72zm11.29-1.45c-1.43-1.74-4.9-2.33-6.36-2.33s-4.93.59-6.36 2.33C4.62 15.49 4 13.82 4 12c0-4.41 3.59-8 8-8s8 3.59 8 8c0 1.82-.62 3.49-1.64 4.83zM12 6c-1.94 0-3.5 1.56-3.5 3.5S10.06 13 12 13s3.5-1.56 3.5-3.5S13.94 6 12 6zm0 5c-.83 0-1.5-.67-1.5-1.5S11.17 8 12 8s1.5.67 1.5 1.5S12.83 11 12 11z"/>
                                
                                <!-- Admin Icon -->
                                <path v-else-if="parseInt(roleId) === 2" d="M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm0 4c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm6 12H6v-1.4c0-2 4-3.1 6-3.1s6 1.1 6 3.1V19z"/>
                                
                                <!-- Evaluator Icon -->
                                <path v-else-if="parseInt(roleId) === 3" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                                
                                <!-- Interviewer Icon -->
                                <path v-else-if="parseInt(roleId) === 4" d="M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z"/>
                                
                                <!-- Medical Staff Icon -->
                                <g v-else-if="parseInt(roleId) === 5">
                                    <path d="M20 8l-8 5-8-5v10h16zm0-2H4l8 4.99z" opacity=".3"/>
                                    <path d="M4 20h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2zM20 6l-8 4.99L4 6h16zM4 8l8 5 8-5v10H4V8z"/>
                                </g>
                                
                                <!-- Registrar Icon -->
                                <path v-else d="M14 6v15H3v-2h2V3h9v1h5v15h2v2h-4V6h-3zm-4 5v2h2v-2h-2z"/>
                            </svg>
                        </div>
                        <div class="stat-content">
                ...
                <div class="form-card">
                    ...
                    <div class="form-header">
                        ...
                        <div>
                            ...
                            <p class="form-subtitle">Update user details and permissions</p>
                        </div>
                    </div>

                    <!-- Error Messages -->
                    <div v-if="form.errors && Object.keys(form.errors).length > 0" class="alert-card error">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <div v-if="form.errors.role_id" class="form-error">
                                        <svg class="error-icon" viewBox="0 0 24 24">
                                            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"/>
                                        </svg>
                                        {{ form.errors.role_id }}
                                ...
                                <div v-if="showApplicantProgram" class="form-group">
                                    ...
                                    <div v-if="form.errors.applicant_program" class="form-error">
                                        <svg class="error-icon" viewBox="0 0 24 24">
                                            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"/>
                                        </svg>
...
<style scoped>
/* All the CSS remains the same as in AddUser.vue */
.page-container {
  min-height: 100vh;
