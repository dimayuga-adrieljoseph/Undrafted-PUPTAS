        ...
        <div class="py-8 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
            <div class="flex flex-col md:flex-row gap-6">
                ...
                >
                    ...
                    <div
                        class="grid grid-cols-5 sm:grid-cols-5 lg:grid-cols-5 gap-2"
                    >
                        <button
                            v-for="program in programs"
                            :key="program.id"
                            @click="goToProgram(program.id)"
                            class="flex flex-col items-center justify-center bg-pink-100 hover:bg-pink-200 text-center p-2 rounded-[50px] shadow transition duration-200 border-2 border-pink-200"
                        >
                            <span
