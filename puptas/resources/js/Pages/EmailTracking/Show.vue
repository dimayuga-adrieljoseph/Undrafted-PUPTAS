<template>
  ...
  <AppLayout>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
      ...
      <!-- Pagination -->
      <div v-if="logs.data.length && logs.last_page > 1" class="px-6 py-4 border-t border-gray-200 dark:border-gray-700">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center space-x-2">
            ...
            <div class="flex items-center space-x-2 mx-2">
                ...
                <span class="px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 font-medium text-sm">{{ logs.last_page || 1 }}</span>
            </div>
