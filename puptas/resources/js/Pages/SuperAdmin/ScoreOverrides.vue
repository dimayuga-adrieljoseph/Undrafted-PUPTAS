    ...
    <SuperAdminLayout>
        <div class="px-4 md:px-8 py-8 w-full max-w-7xl mx-auto">
            ...
            <div class="mb-8 flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Registration Score Overrides</h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1 text-sm">
                        Allow applicants with specific PUPCET scores to bypass registration cutoff and status restrictions.
                    </p>
                </div>
            </div>
        ...
        <ChangesConfirmationModal
            ...
            :title="confirmingAction === 'add' ? 'Confirm Score Override' : 'Revoke Score Override'"
            :subtitle="confirmingAction === 'add' ? 'Are you sure you want to allow this score?' : 'Are you sure you want to revoke this score override?'"
            :loading="confirmingAction === 'add' ? addForm.processing : deleteForm.processing"
            :confirmText="confirmingAction === 'add' ? 'Confirm Allow' : 'Confirm Revoke'"
            :confirmButtonClass="confirmingAction === 'add' ? 'bg-[#9E122C] hover:bg-[#800918] text-white' : 'bg-red-600 hover:bg-red-700 text-white'"
            hideTable
