<template>
  <ApplicantLayout>
    <div class="max-w-4xl mx-auto p-6">
      <h1 class="text-xl font-bold mb-4">TVL Strand Grade Input</h1>
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="mb-8">
          ...
          <div class="mb-6">
            ...
            <div class="mb-2">
              ...
              <input v-model.number="form.g11_general_mathematics" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
            <div class="mb-2">
              <label class="block text-sm">Statistics and Probability</label>
              <input v-model.number="form.g11_statistics_probability" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
          ...
          <div class="mb-6">
            ...
            <div class="mb-3">
              ...
              <input v-model="form.g11_science_subject_1" type="text" class="w-full border px-2 py-1 mb-1" />
              <label class="block text-sm">Grade</label>
              <input v-model.number="form.g11_science_grade_1" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
            <div class="mb-3">
              <label class="block text-sm">Science Subject 2 Name</label>
              <input v-model="form.g11_science_subject_2" type="text" class="w-full border px-2 py-1 mb-1" />
              <label class="block text-sm">Grade</label>
              <input v-model.number="form.g11_science_grade_2" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
          ...
          <div class="mb-6">
            ...
            <div class="mb-2">
              ...
              <input v-model.number="form.g11_oral_communication" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
            <div class="mb-2">
              <label class="block text-sm">Reading and Writing Skills</label>
              <input v-model.number="form.g11_reading_writing" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
            <div class="mb-2">
              <label class="block text-sm">21st Century Literature from the Philippines and the World</label>
              <input v-model.number="form.g11_21st_century_lit" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
        ...
        <div class="mb-8">
          ...
          <!-- Math Subjects -->
          <div class="mb-6">
            <h3 class="font-semibold mb-2">Math Subjects</h3>
            <div class="mb-3">
              <label class="block text-sm">Math Subject 1 Name</label>
              <input v-model="form.g12_math_subject_1" type="text" class="w-full border px-2 py-1 mb-1" />
              <label class="block text-sm">Grade</label>
              <input v-model.number="form.g12_math_grade_1" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
            <div class="mb-3">
              <label class="block text-sm">Math Subject 2 Name</label>
              <input v-model="form.g12_math_subject_2" type="text" class="w-full border px-2 py-1 mb-1" />
              <label class="block text-sm">Grade</label>
              <input v-model.number="form.g12_math_grade_2" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
          </div>

          <!-- Science Subjects -->
          <div class="mb-6">
            <h3 class="font-semibold mb-2">Science Subjects</h3>
            <div class="mb-2">
              <label class="block text-sm">Earth and Life Science</label>
              <input v-model.number="form.g12_science_grade_1" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
            <div class="mb-2">
              <label class="block text-sm">Physical Science</label>
              <input v-model.number="form.g12_science_grade_2" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
            <p class="text-sm font-semibold mb-4">Science Average: {{ scienceAverage || '—' }}</p>
          </div>
          ...
          <!-- English Subjects -->
          <div class="mb-6">
            <h3 class="font-semibold mb-2">English Subjects</h3>
            <div class="mb-3">
              <label class="block text-sm">English Subject 1 Name</label>
              <input v-model="form.g12_english_subject_1" type="text" class="w-full border px-2 py-1 mb-1" />
              <label class="block text-sm">Grade</label>
              <input v-model.number="form.g12_english_grade_1" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
            <div class="mb-3">
              <label class="block text-sm">English Subject 2 Name</label>
              <input v-model="form.g12_english_subject_2" type="text" class="w-full border px-2 py-1 mb-1" />
              <label class="block text-sm">Grade</label>
              <input v-model.number="form.g12_english_grade_2" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
            <div class="mb-3">
              <label class="block text-sm">English Subject 3 Name</label>
              <input v-model="form.g12_english_subject_3" type="text" class="w-full border px-2 py-1 mb-1" />
              <label class="block text-sm">Grade</label>
              <input v-model.number="form.g12_english_grade_3" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
            <p class="text-sm font-semibold mb-4">English Average: {{ englishAverage || '—' }}</p>
          </div>
          ...
          <div class="mb-6">
            ...
            <div class="mb-2">
              ...
              <input v-model.number="form.g12_first_sem_gwa" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
            <div class="mb-2">
              <label class="block text-sm">2nd Semester</label>
              <input v-model.number="form.g12_second_sem_gwa" type="number" min="0" max="100" step="0.01" class="w-full border px-2 py-1" />
            </div>
          </div>
          ...
          <div class="mb-4">
            ...
            <div v-if="qualifiedPrograms.length > 0">
              <div v-for="program in qualifiedPrograms" :key="program.id" class="border p-2 mb-2 bg-green-50">
                ...
                <p class="text-xs">Requirements: Math {{ parseFloat(program.math).toFixed(2) }}, Science {{ parseFloat(program.science).toFixed(2) }}, English {{ parseFloat(program.english).toFixed(2) }}, GWA {{ parseFloat(program.gwa).toFixed(2) }}</p>
              </div>
            </div>
        ...
        <!-- Program choices (same as other forms) -->
        <div class="border p-3 mb-6">
          ...
          <div v-if="qualifiedPrograms.length > 0">
            <div class="mb-3">
              ...
              <select v-model="form.first_choice_program" class="w-full border px-2 py-1" required>
                <option value="">-- Select First Choice --</option>
                <option v-for="program in qualifiedPrograms" :key="program.id" :value="program.id" :disabled="program.id === form.second_choice_program">{{ program.code }} - {{ program.name }}</option>
              </select>
              <p v-if="errors.first_choice_program" class="text-red-500 text-xs mt-1">{{ errors.first_choice_program }}</p>
            </div>

            <div class="mb-3">
              <label class="block text-sm font-semibold mb-1">Second Choice Program *</label>
              <select v-model="form.second_choice_program" class="w-full border px-2 py-1" required>
                <option value="">-- Select Second Choice --</option>
                <option v-for="program in qualifiedPrograms" :key="program.id" :value="program.id" :disabled="program.id === form.first_choice_program">{{ program.code }} - {{ program.name }}</option>
              </select>
              <p v-if="errors.second_choice_program" class="text-red-500 text-xs mt-1">{{ errors.second_choice_program }}</p>
            </div>
          ...
          <p v-if="errors.programs" class="text-red-500 text-xs mt-2">{{ errors.programs }}</p>
        </div>

        <button type="submit" :disabled="loading" class="w-full bg-red-500 hover:bg-red-600 text-white font-bold py-2 mb-2">{{ loading ? 'Saving...' : 'Save Grades' }}</button>
        <button type="button" @click="$inertia.visit('/applicant-dashboard')" class="w-full bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2">Cancel</button>

        <div v-if="successMessage" class="border border-green-500 bg-green-100 text-green-700 px-3 py-2 mt-3">{{ successMessage }}</div>
      </form>
    </div>
  </ApplicantLayout>
</template>
...
const page = usePage()
const props = defineProps({ grade: Object, user: Object, programs: Array, strand: String })
...
const mathAverage = computed(() => {
  const grades = [form.g11_general_mathematics, form.g11_statistics_probability, form.g12_math_grade_1, form.g12_math_grade_2].filter(g => g !== null && g !== '')
  return grades.length > 0 ? (grades.reduce((a, b) => a + b, 0) / grades.length).toFixed(2) : null
})

const scienceAverage = computed(() => {
  const grades = [form.g11_science_grade_1, form.g11_science_grade_2, form.g12_science_grade_1, form.g12_science_grade_2].filter(g => g !== null && g !== '')
  return grades.length > 0 ? (grades.reduce((a, b) => a + b, 0) / grades.length).toFixed(2) : null
})

const englishAverage = computed(() => {
  const grades = [form.g11_oral_communication, form.g11_reading_writing, form.g11_21st_century_lit, form.g12_english_grade_1, form.g12_english_grade_2, form.g12_english_grade_3].filter(g => g !== null && g !== '')
  return grades.length > 0 ? (grades.reduce((a, b) => a + b, 0) / grades.length).toFixed(2) : null
})

const g12GWA = computed(() => {
  const semGrades = [form.g12_first_sem_gwa, form.g12_second_sem_gwa].filter(g => g !== null && g !== '')
  return semGrades.length > 0 ? (semGrades.reduce((a, b) => a + b, 0) / semGrades.length).toFixed(2) : null
})

const qualifiedPrograms = computed(() => {
  if (!props.programs || !mathAverage.value || !scienceAverage.value || !englishAverage.value || !g12GWA.value) return []
...
const notQualifiedPrograms = computed(() => {
  if (!props.programs || !mathAverage.value || !scienceAverage.value || !englishAverage.value || !g12GWA.value) return props.programs || []
  return props.programs.filter(program => {
...
const submitForm = async () => {
  ...
  if (!mathAverage.value || !scienceAverage.value || !englishAverage.value || !g12GWA.value) {
  ...
  router.post('/grades/tvl', payload, {
    ...
    onSuccess: (response) => {
      ...
      setTimeout(() => { router.visit('/applicant-dashboard') }, 1000)
      loading.value = false
    },
