                    ...
                    <div class="mb-4">
                        ...
                        <div v-if="qualifiedPrograms.length > 0">
                            ...
                            >
                                ...
                                <p class="text-xs">
                                    Requirements: Math
                                    {{ parseFloat(program.math).toFixed(2) }},
                                    Science
                                    {{
                                        parseFloat(program.science).toFixed(2)
                                    }}, English
                                    {{
                                        parseFloat(program.english).toFixed(2)
                                    }}, GWA
                                    {{ parseFloat(program.gwa).toFixed(2) }}
                                </p>
                            </div>
                        </div>
