                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input
                                        v-model="form.g12_earth_life_science"
                                        type="text" inputmode="decimal"
                                        @keydown="preventInvalidInput" @input="validateGrade"
                                ...
                                <div>
                                    ...
                                    <input
                                        v-model="form.g12_physical_science"
                                        type="text" inputmode="decimal"
                                        @keydown="preventInvalidInput" @input="validateGrade"
...
// TVL-specific default subjects
const tvlDefaultSubjects = {
    math: [
...
const {
    ...
    strand: props.strand || 'TVL',
    defaultSubjects: tvlDefaultSubjects,
    grade: props.grade,
...
const reviewSections = computed(() => [
    ...
    },
    {
        ...
        items: [
            { label: 'Earth and Life Science', value: form.g12_earth_life_science },
            { label: 'Physical Science', value: form.g12_physical_science },
        ],
    },
    {
        title: 'Grade 12 GWA',
