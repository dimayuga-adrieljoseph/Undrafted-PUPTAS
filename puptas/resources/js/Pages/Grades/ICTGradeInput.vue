            ...
            <form @submit.prevent="submitForm">
                ...
                <div class="mb-8">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-2">
                            <label class="block text-sm"
                                >21st Century Literature from Philippines and
                                the World</label
                            >
                            <input
                        ...
                        <div v-if="qualifiedPrograms.length > 0">
                            ...
                            >
                                ...
                                <p class="text-xs">
                                    ...
                                    English {{ program.english }}, Science
                                    {{ program.science }}, GWA {{ program.gwa }}
                                </p>
                            </div>
                        </div>
