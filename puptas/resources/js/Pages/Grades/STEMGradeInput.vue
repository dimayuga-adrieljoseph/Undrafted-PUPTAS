      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="mb-8">
          ...
          <div class="mb-6">
            ...
            <div class="mb-2">
              <label class="block text-sm">General Chemistry 1</label>
              <input
        ...
        <div class="mb-8">
          ...
          <!-- Math Subjects (4) -->
          <div class="mb-6">
            <h3 class="font-semibold mb-2">Math Subjects (4 subjects)</h3>
            <div class="mb-3">
            ...
            <div class="mb-3">
              <label class="block text-sm">Math Subject 3 Name</label>
              <input
            ...
            <div class="mb-3">
              <label class="block text-sm">Math Subject 4 Name</label>
              <input
          ...
          <!-- Science Subjects (5) -->
          <div class="mb-6">
            <h3 class="font-semibold mb-2">Science Subjects (5 subjects)</h3>
            <div class="mb-2">
              <label class="block text-sm">General Physics 1</label>
              <input
            ...
            <div class="mb-2">
              <label class="block text-sm">General Biology 1</label>
              <input
            ...
            <div class="mb-2">
              <label class="block text-sm">General Physics 2</label>
              <input
            ...
            <div class="mb-2">
              <label class="block text-sm">General Biology 2</label>
              <input
            ...
            <div class="mb-2">
              <label class="block text-sm">General Chemistry 2</label>
              <input
          ...
          <!-- English Subjects (2) -->
          <div class="mb-6">
            <h3 class="font-semibold mb-2">English Subjects (2 subjects)</h3>
            <div class="mb-2">
          ...
          <div class="mb-4">
            ...
            <div v-if="qualifiedPrograms.length > 0">
              <div v-for="program in qualifiedPrograms" :key="program.id" class="border p-2 mb-2 bg-green-50">
                ...
                <p class="text-xs">Requirements: Math {{ program.math }}, Science {{ program.science }}, English {{ program.english }}, GWA {{ program.gwa }}</p>
              </div>
            </div>
...
const qualifiedPrograms = computed(() => {
  if (!props.programs || !mathAverage.value || !scienceAverage.value || !englishAverage.value || !g12GWA.value) {
    return []
  }
