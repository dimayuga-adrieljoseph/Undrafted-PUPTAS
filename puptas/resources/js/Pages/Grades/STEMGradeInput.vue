<template>
    <ApplicantLayout>
        <div class="max-w-4xl mx-auto p-6">
            <h1 class="text-xl font-bold mb-4">STEM Strand Grade Input</h1>
            <p class="mb-6">
                Enter your academic grades for Grade 11 and Grade 12
            </p>
            ...
            <form @submit.prevent="submitForm">
                ...
                <div class="mb-8">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-2">
                            <label class="block text-sm"
                                >Statistics and Probability</label
                            >
                            <input
                        ...
                        <div class="mb-2">
                            <label class="block text-sm">Pre-Calculus</label>
                            <input
                        ...
                        <div class="mb-2">
                            <label class="block text-sm">Basic Calculus</label>
                            <input
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-2">
                            <label class="block text-sm">Earth Science</label>
                            <input
                        ...
                        <p class="text-sm font-semibold mb-4">
                            Science Average: {{ scienceAverage || "—" }}
                        </p>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-2">
                            <label class="block text-sm"
                                >Oral Communication in Context</label
                            >
                            <input
                        ...
                        <div class="mb-2">
                            <label class="block text-sm"
                                >Reading and Writing Skills</label
                            >
                            <input
                        ...
                        <p class="text-sm font-semibold mb-4">
                            English Average: {{ englishAverage || "—" }}
                        </p>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="mb-6">
                        <h3 class="font-semibold mb-2">
                            Math Subjects (4 subjects)
                        </h3>
                        <div class="mb-3">
                            <label class="block text-sm"
                                >Math Subject 1 Name</label
                            >
                            <input
                        ...
                        <div class="mb-3">
                            <label class="block text-sm"
                                >Math Subject 4 Name</label
                            >
                            <input
                                v-model="form.g12_math_subject_4"
                                type="text"
                                class="w-full border px-2 py-1 mb-1"
                            />
                            <label class="block text-sm">Grade</label>
                            <input
                                v-model.number="form.g12_math_grade_4"
                                type="number"
                                min="0"
                                max="100"
                                step="0.01"
                    ...
                    <div class="mb-6">
                        <h3 class="font-semibold mb-2">
                            Science Subjects (5 subjects)
                        </h3>
                        <div class="mb-2">
                            <label class="block text-sm"
                                >General Physics 1</label
                            >
                            <input
                ...
                <div class="border p-3 mb-6">
                    ...
                    <p class="text-sm">
                        Math Average: <strong>{{ mathAverage || "—" }}</strong>
                    </p>
                    <p class="text-sm">
                        Science Average:
                        <strong>{{ scienceAverage || "—" }}</strong>
                    </p>
                    <p class="text-sm">
                        English Average:
                        <strong>{{ englishAverage || "—" }}</strong>
                    </p>
                    <p class="text-sm">
                        Grade 12 GWA: <strong>{{ g12GWA || "—" }}</strong>
                    </p>
                </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div v-if="qualifiedPrograms.length > 0">
                            <div
                                ...
                                :key="program.id"
                                class="border p-2 mb-2 bg-green-50"
                            >
                                <p class="font-semibold text-sm">
                                    {{ program.code }} - {{ program.name }}
                                </p>
                                <p class="text-xs">
                                    Requirements: Math {{ program.math }},
                                    Science {{ program.science }}, English
                                    {{ program.english }}, GWA {{ program.gwa }}
                                </p>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div v-if="notQualifiedPrograms.length > 0">
                            <div
                                ...
                                :key="program.id"
                                class="border p-2 mb-2 bg-red-50"
                            >
                                <p class="font-semibold text-sm">
                                    {{ program.code }} - {{ program.name }}
                                </p>
                ...
                <div class="border p-3 mb-6">
                    <h3 class="font-semibold mb-3 text-red-600">
                        * Choose Your Programs (Required)
                    </h3>

                    <div v-if="qualifiedPrograms.length > 0">
                        <div class="mb-3">
                            <label class="block text-sm font-semibold mb-1"
                                >First Choice Program *</label
                            >
                            <select
                            ...
                            <p
                                v-if="errors.first_choice_program"
                        ...
                        <div class="mb-3">
                            ...
                            >
                                ...
                                <option
                                    ...
                                    :value="program.id"
                                    :disabled="
                                        program.id === form.first_choice_program
                                    "
                                >
                                    {{ program.code }} - {{ program.name }}
                                </option>
                            ...
                            <p
                                v-if="errors.second_choice_program"
                                class="text-red-500 text-xs mt-1"
                            >
                        ...
                        <div
                            v-if="
                                form.first_choice_program ||
                                form.second_choice_program
                            "
                            class="border p-2 bg-blue-50 mt-2"
                        >
                            <p class="font-semibold text-sm mb-1">
                                Your Selected Programs:
                            </p>
                            <p v-if="form.first_choice_program" class="text-sm">
                                1st Choice:
                                <strong>{{
                            ...
                            <p
                                v-if="form.second_choice_program"
                                class="text-sm"
                            >
                                2nd Choice:
                                <strong>{{
                    ...
                    <div v-else class="text-red-600 p-2 bg-red-50">
                        <p class="font-semibold text-sm">
                            ⚠️ No Qualified Programs
                        </p>
                        <p class="text-xs">
                            You need to enter all your grades to see which
                ...
                <div
                    v-if="successMessage"
                    class="border border-green-500 bg-green-100 text-green-700 px-3 py-2 mt-3"
                >
                    {{ successMessage }}
                </div>
            </form>
...
const form = reactive({
    ...
    g11_pre_calculus: null,
    g11_basic_calculus: null,
...
const currentStrand = computed(() => (props.strand || "STEM").toUpperCase());
