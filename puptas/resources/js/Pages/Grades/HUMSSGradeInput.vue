            ...
            <Transition name="slide-down">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="mt-3">
                                ...
                                <p v-else class="text-xs text-amber-600 dark:text-amber-400 mt-1">
                                    <i class="fas fa-info-circle mr-1"></i>Maximum of 5 additional subjects reached for Math.
                                </p>
                            </div>
                            ...
                            <div class="mt-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg inline-block">
                                <p class="text-sm font-medium text-blue-700 dark:text-blue-300">
                                    ...
                                    <span v-if="mathCount > 0" class="ml-2 text-xs text-blue-500 dark:text-blue-400">({{ mathCount }} subject{{ mathCount !== 1 ? 's' : '' }})</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="mt-3">
                                ...
                                <p v-else class="text-xs text-amber-600 dark:text-amber-400 mt-1">
                                    <i class="fas fa-info-circle mr-1"></i>Maximum of 5 additional subjects reached for English.
                                </p>
                            </div>
                            ...
                            <div class="mt-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg inline-block">
                                <p class="text-sm font-medium text-blue-700 dark:text-blue-300">
                                    ...
                                    <span v-if="englishCount > 0" class="ml-2 text-xs text-blue-500 dark:text-blue-400">({{ englishCount }} subject{{ englishCount !== 1 ? 's' : '' }})</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="mt-3">
                                ...
                                <p v-else class="text-xs text-amber-600 dark:text-amber-400 mt-1">
                                    <i class="fas fa-info-circle mr-1"></i>Maximum of 5 additional subjects reached for Science.
                                </p>
                            </div>
                            ...
                            <div class="mt-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg inline-block">
                                <p class="text-sm font-medium text-blue-700 dark:text-blue-300">
                                    ...
                                    <span v-if="scienceCount > 0" class="ml-2 text-xs text-blue-500 dark:text-blue-400">({{ scienceCount }} subject{{ scienceCount !== 1 ? 's' : '' }})</span>
                                </p>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-200 dark:border-gray-700">
                        ...
                        <p v-if="mathCount > 0" class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ mathCount }} subject{{ mathCount !== 1 ? 's' : '' }}</p>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-200 dark:border-gray-700">
                        ...
                        <p v-if="englishCount > 0" class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ englishCount }} subject{{ englishCount !== 1 ? 's' : '' }}</p>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-200 dark:border-gray-700">
                        ...
                        <p v-if="scienceCount > 0" class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ scienceCount }} subject{{ scienceCount !== 1 ? 's' : '' }}</p>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-200 dark:border-gray-700">
