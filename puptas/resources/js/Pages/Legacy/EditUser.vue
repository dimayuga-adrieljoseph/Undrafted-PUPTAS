<template>
  ...
  <AppLayout>
    <div class="container">
      <div class="form-card">
        <Link :href="route('users.index')" class="form-button cancel" style="margin-bottom: 1rem;">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="form-group">
            ...
            <select id="role_id" v-model="form.role_id" required @change="onRoleChange">
          ...
          <div class="form-group" v-show="showProgramField" id="program-group">
