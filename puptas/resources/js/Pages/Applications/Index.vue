...
<template>
    ...
    <component :is="currentLayout">
        ...
        <div v-if="userNotFoundError" class="mb-4 p-4 bg-red-50 border border-red-200 text-red-700 rounded-2xl flex items-start gap-3 dark:bg-red-950/30 dark:border-red-800 dark:text-red-300">
            <svg class="w-5 h-5 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/>
            </svg>
            <div class="flex-1">
                <p class="font-semibold text-sm">Applicant Not Found</p>
                <p class="text-sm mt-0.5">{{ userNotFoundError }}</p>
            </div>
            <button @click="userNotFoundError = null" class="text-red-400 hover:text-red-600 dark:hover:text-red-200 transition">
        ...
        <!-- Page Header -->
        <div class="mb-5">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">All Applications</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                Browse and manage all applicants across every admission stage.
            </p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-6 dark:bg-gray-800">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                >
                    ...
                    <option value="document_evaluator">Document Evaluation</option>
                    <option value="grade_evaluator">Grade Evaluation</option>
                    <option value="interviewer">For Interview</option>
                    <option value="medical">For Medical</option>
                    <option value="records">For Records</option>
        ...
        <!-- Loading / Error -->
        <div v-if="loading" class="py-12 text-center text-gray-500 dark:text-gray-400">Loading applicants…</div>
        <div v-else-if="fetchError" class="py-8 text-center text-red-600 dark:text-red-400">Error: {{ fetchError }}</div>
        ...
        <div v-else class="bg-white rounded-2xl shadow-lg overflow-hidden dark:bg-gray-800">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-[600px] w-full divide-y divide-gray-200 dark:divide-gray-700 table-fixed">
                    <colgroup>
                        <col class="w-[35%]" />   <!-- name -->
                        <col class="w-[30%]" />   <!-- course -->
                        <col class="w-[20%]" />   <!-- stage -->
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr v-if="paginatedUsers.length === 0" class="bg-gray-50 dark:bg-gray-900">
                            <td colspan="4" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center gap-3">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">Try adjusting your search or stage filter.</p>
                                </div>
                            </td>
                        </tr>
                        <!-- Rows -->
                        ...
                        >
                            ...
                            <td class="px-4 py-3">
                                <span
                                    v-if="user.stage"
                                    :class="stageColorMap[user.stage]"
        ...
        >
            <div class="relative max-w-4xl w-full">
                <img :src="previewImage" alt="Preview" class="w-full h-auto rounded-2xl shadow-2xl" />
                <button
