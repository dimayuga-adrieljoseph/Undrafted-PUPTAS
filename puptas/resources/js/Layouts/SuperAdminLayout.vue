...
<template>
    <div class="min-h-screen flex bg-gradient-to-br from-purple-50 to-[#faf6f2] dark:from-gray-950 dark:to-gray-900">

        <Sidebar variant="superadmin" v-model:open="sidebarOpen" />
        ...
        <div class="flex-1 flex flex-col ml-0 md:ml-[var(--sidebar-width,5rem)]">
            ...
            <header class="sticky top-0 z-40 h-16 px-6 flex items-center justify-between bg-white/80 backdrop-blur border-b border-gray-200 dark:bg-gray-900/80 dark:border-gray-800">
                <div class="flex items-center gap-4">
                    ...
                    <slot name="title">
                        <h1 class="text-lg md:text-xl font-semibold text-gray-800 dark:text-gray-100">Superadmin Dashboard</h1>
                    </slot>
                </div>
