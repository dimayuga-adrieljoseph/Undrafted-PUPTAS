...
<template>
    <div
        class="min-h-screen flex bg-gradient-to-br from-purple-50 to-[#faf6f2] dark:from-gray-950 dark:to-gray-900"
    >
        <!-- Sidebar -->
        <Sidebar variant="superadmin" :isMobileOpen="isMobileSidebarOpen" @close="isMobileSidebarOpen = false" />
