...
<template>
    <div class="min-h-screen bg-gradient-to-br from-[#faf6f2] to-[#f1ebe6] dark:from-gray-950 dark:to-gray-900 flex">
        ...
        <!-- Sidebar — v-model:open is viewport-aware -->
        ...
        <div class="flex-1 flex flex-col ml-0 md:ml-[var(--sidebar-width,5rem)]">
            ...
            >
                <div class="flex items-center gap-4">
                    <!-- Hamburger (mobile only) — toggles v-model:open -->
                    <button
                    ...
                    <slot name="title">
                        <h1 class="text-lg md:text-xl font-semibold text-gray-800 dark:text-gray-100">Admin Portal</h1>
                    </slot>
                </div>
