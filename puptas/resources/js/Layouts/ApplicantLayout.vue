...
// 1) Declare a reactive ref for dark mode
...
function toggleDarkMode() {
    // 3) Flip ref, update class & localStorage
...
watchEffect(() => {
    isTeamMenuOpen.value = ["teams.show", "teams.create", "teams.index"].some(
        (r) => isActiveRoute(r)
    );
    isUserMenuOpen.value = ["profile.show", "api-tokens.index"].some((r) =>
        isActiveRoute(r)
    );
});
            ...
            <div class="mb-10 flex items-center justify-center">
                ...
                >
                    <FontAwesomeIcon
                        ...
                        class="text-2xl transform transition-transform duration-300 ease-in-out"
                    />
                </button>
            </div>
