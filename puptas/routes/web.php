...
Route::get('/legacy/manage-users', [UserController::class, 'index'])->name('users.index')->middleware('auth');
Route::get('/legacy/users/{id}/edit', [UserController::class, 'edit'])->name('users.edit')->middleware('auth');
Route::post('/legacy/users/{id}/update', [UserController::class, 'update'])->name('users.update')->middleware('auth');
Route::delete('/legacy/users/{id}/delete', [UserController::class, 'destroy'])->name('users.destroy')->middleware('auth');

// show form
Route::get('/legacy/add-user', [UserController::class, 'create'])->name('legacy.add_user')->middleware('auth');

// handle form submission
Route::post('/legacy/add-user/store', [UserController::class, 'store'])->name('add_user.store')->middleware('auth');
...
Route::get('/admin/users/edit/{id}', [AssignController::class, 'editUser'])->name('admin.users.edit')->middleware('auth');
Route::post('/admin/users/update/{id}', [AssignController::class, 'updateUser'])->name('admin.users.update')->middleware('auth');
Route::delete('/admin/users/delete/{id}', [AssignController::class, 'deleteUser'])->name('admin.users.delete')->middleware('auth');
